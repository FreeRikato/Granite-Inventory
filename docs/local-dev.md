...
- Hosted project `nugnqzqglldacalkmgyn` needs the same client ID and secret pasted into its Auth provider settings before the first deploy. That is a handover step, not part of any Phase 1 ticket.
